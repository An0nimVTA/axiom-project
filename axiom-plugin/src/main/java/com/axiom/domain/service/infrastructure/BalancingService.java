...
public class BalancingService {
    ...
    public synchronized boolean canClaimChunk(String nationId, String world, int chunkX, int chunkZ) {
        ...
        Set<String> claimed = n.getClaimedChunkKeys();
        int claimedCount = claimed != null ? claimed.size() : 0;
        if (claimedCount < 5) {
            return true;
        }
        ...
        int capitalZ;
        try {
            capitalX = Integer.parseInt(capitalParts[1]);
            capitalZ = Integer.parseInt(capitalParts[2]);
    ...
    public synchronized Map<String, Object> getBalancingStatistics(String nationId) {
        ...
        // Territory stats
        int claimedChunks = n.getClaimedChunkKeys() != null ? n.getClaimedChunkKeys().size() : 0;
        stats.put("claimedChunks", claimedChunks);
        ...
        if (claimedChunks > 100) rating = "ОБШИРНАЯ ТЕРРИТОРИЯ";
    ...
    public synchronized Map<String, Object> getGlobalBalancingStatistics() {
        ...
        for (Nation n : nationManager.getAll()) {
            ...
            // Territory
            totalClaimedChunks += n.getClaimedChunkKeys() != null ? n.getClaimedChunkKeys().size() : 0;
        }
