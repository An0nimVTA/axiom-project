...
public class CulturalRevolutionService {
    ...
    private synchronized void processRevolutions() {
        ...
        for (Map.Entry<String, CulturalRevolution> e : activeRevolutions.entrySet()) {
            ...
            double happiness = happinessService != null ? happinessService.getNationHappiness(e.getKey()) : 0.0;
            double education = educationService != null ? educationService.getEducationLevel(e.getKey()) : 0.0;
            ...
            switch (rev.type.toLowerCase()) {
                case "progressive":
                    if (educationService != null) {
                        educationService.addResearchProgress(e.getKey(), 10.0);
                    }
                    break;
                case "conservative":
                    if (happinessService != null) {
                        happinessService.modifyHappiness(e.getKey(), 5.0);
                    }
                    break;
                case "religious":
                    if (cultureService != null) {
                        cultureService.addCulturalScore(e.getKey(), 5.0);
                    }
                    break;
                case "secular":
                    if (educationService != null) {
                        educationService.addResearchProgress(e.getKey(), 15.0);
                    }
                    break;
            }
            if (rev.progress >= 100) {
                rev.active = false;
                Nation n = nationManager != null ? nationManager.getNationById(e.getKey()) : null;
                if (n != null) {
                    ...
                    switch (rev.type.toLowerCase()) {
                        case "progressive":
                            if (educationService != null) {
                                educationService.addResearchProgress(e.getKey(), 100.0);
                            }
                            break;
                        case "conservative":
                            if (happinessService != null) {
                                happinessService.modifyHappiness(e.getKey(), 20.0);
                            }
                            break;
                        case "religious":
                            if (cultureService != null) {
                                cultureService.addCulturalScore(e.getKey(), 50.0);
                            }
                            break;
                        case "secular":
                            if (educationService != null) {
                                educationService.addResearchProgress(e.getKey(), 150.0);
                            }
                            break;
                    }
    ...
    public synchronized Map<String, Object> getCulturalRevolutionStatistics(String nationId) {
        ...
        if (rev != null) {
            ...
            double happiness = plugin.getHappinessService() != null ? plugin.getHappinessService().getNationHappiness(nationId) : 0.0;
            double education = plugin.getEducationService() != null ? plugin.getEducationService().getEducationLevel(nationId) : 0.0;
