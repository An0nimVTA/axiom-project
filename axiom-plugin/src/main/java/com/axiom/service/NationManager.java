...
public class NationManager {
    ...
    // JSON mapping per required schema
    ...
    private Nation deserializeNation(JsonObject o) {
        ...
        String currency = o.has("currency") ? o.get("currency").getAsString() : plugin.getConfig().getString("economy.defaultCurrencyCode", "AXC");
        ...
        JsonArray claims = o.has("claimedChunks")
            ? o.getAsJsonArray("claimedChunks")
            : o.has("claimedChunkKeys")
                ? o.getAsJsonArray("claimedChunkKeys")
                : null;
        if (claims != null) {
        ...
        // Make leader a member with LEADER role for runtime permissions
