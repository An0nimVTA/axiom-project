...
public class SupplyChainService {
    ...
    public synchronized String createChain(String sourceCityId, String targetCityId, String resourceType, double ratePerHour) throws IOException {
        ...
        com.axiom.model.City sourceCity = plugin.getCityGrowthEngine().getCity(sourceCityId);
        com.axiom.model.City targetCity = plugin.getCityGrowthEngine().getCity(targetCityId);
