...
public class ModPackManagerCommand implements CommandExecutor {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "/modpackm list" + ChatColor.WHITE + " - List available mod packs");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm info <packId>" + ChatColor.WHITE + " - View mod pack details");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm enable <packId>" + ChatColor.WHITE + " - Enable a mod pack");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm disable <packId>" + ChatColor.WHITE + " - Disable a mod pack");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm available" + ChatColor.WHITE + " - List available mod packs for your nation");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm stats" + ChatColor.WHITE + " - Show mod pack statistics");
        sender.sendMessage(ChatColor.YELLOW + "/modpackm reload" + ChatColor.WHITE + " - Reload mod pack configuration");
    }
    ...
    private boolean handleInfoCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/modpackm info <packId>");
            return true;
        }
    ...
    private boolean handleEnableCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/modpackm enable <packId>");
            return true;
        }
    ...
    private boolean handleDisableCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/modpackm disable <packId>");
            return true;
        }
