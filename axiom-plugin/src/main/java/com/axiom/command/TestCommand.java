...
public class TestCommand implements CommandExecutor {
    ...
    private void listAvailableTests(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "1. Service Tests");
        sender.sendMessage(ChatColor.YELLOW + "2. Repository Tests");
        sender.sendMessage(ChatColor.YELLOW + "3. Cache Tests");
        sender.sendMessage(ChatColor.YELLOW + "4. Validation Tests");
        sender.sendMessage(ChatColor.YELLOW + "5. Integration Tests");
        sender.sendMessage(ChatColor.YELLOW + "6. Performance Tests");
