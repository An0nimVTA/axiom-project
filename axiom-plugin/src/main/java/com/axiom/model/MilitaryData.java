...
public class MilitaryData {
    ...
    public void setInfantry(int infantry) { this.infantry = infantry; updateStrength(); }
    
    public int getCavalry() { return cavalry; }
    public void setCavalry(int cavalry) { this.cavalry = cavalry; updateStrength(); }
    
    public int getArtillery() { return artillery; }
    public void setArtillery(int artillery) { this.artillery = artillery; updateStrength(); }
    
    public int getNavy() { return navy; }
    public void setNavy(int navy) { this.navy = navy; updateStrength(); }
    
    public int getAirForce() { return airForce; }
    public void setAirForce(int airForce) { this.airForce = airForce; updateStrength(); }
    ...
    /**
     * Пересчитать производные показатели на основе состава войск
     */
