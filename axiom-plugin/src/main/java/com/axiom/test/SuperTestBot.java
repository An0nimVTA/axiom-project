...
public class SuperTestBot {
    ...
    private void runAllServiceTests(Player commander) {
        ...
        testServiceStatsMethod(commander, "UnifiedEspionage", plugin.getUnifiedEspionageService());
    ...
    private void runGuiMenuTests(Player commander) {
        ...
        // Test NationMainMenu by attempting to open it
        try {
            plugin.openNationMainMenu(commander);
            commander.sendMessage("§a[SUCCESS] NationMainMenu opened successfully");
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to open NationMainMenu: " + e.getMessage());
        }
        testGuiMenuAvailability(commander, "ConfirmMenu", plugin.getConfirmMenu());
        // Test TechnologyMenu by attempting to open it
        try {
            plugin.openAdvancedTechnologyTreeMenu(commander);
            commander.sendMessage("§a[SUCCESS] AdvancedTechnologyTreeMenu opened successfully");
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to open AdvancedTechnologyTreeMenu: " + e.getMessage());
        }
        // Test ReligionMenu by attempting to open it
        try {
            plugin.openReligionMenu(commander);
            commander.sendMessage("§a[SUCCESS] ReligionMenu opened successfully");
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to open ReligionMenu: " + e.getMessage());
        }
        // Test CitiesMenu by attempting to open it
        try {
            plugin.openCitiesMenu(commander);
            commander.sendMessage("§a[SUCCESS] CitiesMenu opened successfully");
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to open CitiesMenu: " + e.getMessage());
        }
        
        // Test EconomicIndicatorsMenu by attempting to open it
        try {
            plugin.openEconomicIndicatorsMenu(commander);
            commander.sendMessage("§a[SUCCESS] EconomicIndicatorsMenu opened successfully");
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to open EconomicIndicatorsMenu: " + e.getMessage());
        }
        
        // Test EconomicIndicatorsService functionality
        try {
            var testSuite = new com.axiom.test.EconomicIndicatorsTestSuite(plugin);
            boolean success = testSuite.runAllTests(commander);
            if (success) {
                commander.sendMessage("§a[SUCCESS] All economic indicators tests passed");
            } else {
                commander.sendMessage("§c[FAILURE] Some economic indicators tests failed");
            }
        } catch (Exception e) {
            commander.sendMessage("§c[ERROR] Failed to run economic indicators tests: " + e.getMessage());
        }
    }
