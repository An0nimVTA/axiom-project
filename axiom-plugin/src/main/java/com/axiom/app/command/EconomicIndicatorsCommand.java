...
import com.axiom.domain.service.industry.EconomicTrend;
...
public class EconomicIndicatorsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("axiom.economic.indicators")) {
    ...
    private void showHelp(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "/econom" + ChatColor.GRAY + " - Открыть GUI меню");
        sender.sendMessage(ChatColor.YELLOW + "/econom stats" + ChatColor.GRAY + " - Глобальные статистики");
        sender.sendMessage(ChatColor.YELLOW + "/econom gdp" + ChatColor.GRAY + " - Рейтинг по ВВП");
        sender.sendMessage(ChatColor.YELLOW + "/econom development" + ChatColor.GRAY + " - Рейтинг по уровню развития");
        sender.sendMessage(ChatColor.YELLOW + "/econom inflation" + ChatColor.GRAY + " - Рейтинг по инфляции");
        sender.sendMessage(ChatColor.YELLOW + "/econom unemployment" + ChatColor.GRAY + " - Рейтинг по безработице");
        sender.sendMessage(ChatColor.YELLOW + "/econom trade" + ChatColor.GRAY + " - Торговые балансы");
        sender.sendMessage(ChatColor.YELLOW + "/econom budget" + ChatColor.GRAY + " - Бюджетные балансы");
        sender.sendMessage(ChatColor.YELLOW + "/econom my" + ChatColor.GRAY + " - Показатели моей нации");
        sender.sendMessage(ChatColor.YELLOW + "/econom trends" + ChatColor.GRAY + " - Тренды экономических показателей");
        sender.sendMessage(ChatColor.YELLOW + "/econom help" + ChatColor.GRAY + " - Показать эту справку");
    }
    ...
    private boolean handleGdpCommand(CommandSender sender) {
        ...
        // Сортировка по ВВП
        var sortedByGdp = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private boolean handleDevelopmentCommand(CommandSender sender) {
        ...
        var sortedByDev = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private boolean handleInflationCommand(CommandSender sender) {
        ...
        var sortedByLowInflation = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
        ...
        var sortedByHighInflation = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private boolean handleUnemploymentCommand(CommandSender sender) {
        ...
        var sortedByLowUnemployment = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
        ...
        var sortedByHighUnemployment = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private boolean handleTradeCommand(CommandSender sender) {
        ...
        var sortedByTrade = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private boolean handleBudgetCommand(CommandSender sender) {
        ...
        var sortedByBudgetBalance = new java.util.ArrayList<com.axiom.domain.service.industry.EconomicIndicatorsService.EconomicData>(allData);
    ...
    private ChatColor getTrendColor(com.axiom.domain.service.industry.EconomicTrend trend) {
        switch (trend) {
