    ...
    protected void fillInventoryWithCards() {
        ...
        addCard(new Card(
            ...
            (player) -> {
                ...
                new com.axiom.app.gui.BankingMenu(plugin, player).open();
            }
        ));
        ...
        addCard(new Card(
            ...
            (player) -> {
                ...
                if (plugin.getTradingPostService() != null) {
                    plugin.getTradingPostService().openTradingMenu(player);
                } else {
                    player.sendMessage("Trading service unavailable.");
                }
            }
        ));
        ...
        addCard(new Card(
            ...
            (player) -> {
                ...
                if (plugin.getStockMarketService() != null) {
                    plugin.getStockMarketService().openStockMarket(player); // Assuming method exists now
                }
            }
        ));
    }
