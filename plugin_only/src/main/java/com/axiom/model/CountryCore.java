...
public class CountryCore {
    ...
    /**
     * Удалить подчиненное ядро города
     */
    public void removeSubordinateCore(CityCore core) {
        subordinateCores.remove(core);
    }
    ...
    /**
     * Получить список подчиненных ядер
     */
    public List<CityCore> getSubordinateCores() {
        return new ArrayList<>(subordinateCores);
    }
    
    /**
     * Получить количество подчиненных городов
     */
