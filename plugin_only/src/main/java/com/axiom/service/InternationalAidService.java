                    ...
                    if (recipient != null) {
                        switch (aid.type.toLowerCase()) {
                            case "humanitarian":
                                ...
                                plugin.getHappinessService().modifyHappiness(e.getKey(), 10.0);
                                break;
                            case "economic":
                                recipient.setTreasury(recipient.getTreasury() + aid.amount * 1.5);
                                break;
                            case "military":
                                plugin.getMilitaryService().recruitUnits(e.getKey(), "infantry", 10, 0);
                                break;
                            case "technical":
                                plugin.getEducationService().addResearchProgress(e.getKey(), 50.0);
                                break;
                        }
