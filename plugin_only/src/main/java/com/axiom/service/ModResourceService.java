...
public class ModResourceService {
    ...
    public Map<String, Object> getResourceStatistics(String nationId) {
        ...
        if (resourceService != null) {
            ...
            double totalValue = resources.values().stream().mapToDouble(Double::doubleValue).sum();
        ...
        for (Map.Entry<String, String> entry : modItemToResource.entrySet()) {
            ...
            if (modIntegration.isModAvailable(modId)) {
    ...
    public synchronized Map<String, Object> getGlobalModResourceStatistics() {
        ...
        availableMods.put("appliedenergistics2", modIntegration.isModAvailable("appliedenergistics2"));
        availableMods.put("immersiveengineering", modIntegration.isModAvailable("immersiveengineering"));
        availableMods.put("tacz", modIntegration.isModAvailable("tacz"));
        availableMods.put("pointblank", modIntegration.isModAvailable("pointblank"));
        availableMods.put("simplyquarries", modIntegration.isModAvailable("simplyquarries"));
        availableMods.put("industrialupgrade", modIntegration.isModAvailable("industrialupgrade"));
        availableMods.put("ballistix", modIntegration.isModAvailable("ballistix"));
        availableMods.put("superwarfare", modIntegration.isModAvailable("superwarfare"));
