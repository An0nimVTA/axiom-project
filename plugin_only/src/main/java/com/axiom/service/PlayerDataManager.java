        ...
        if (key.equals("religion") && value != null && !value.equals(oldValue)) {
            org.bukkit.Bukkit.getScheduler().runTask(plugin, () -> {
                ...
                if (player != null && player.isOnline()) {
                    var religionData = plugin.getReligionManager().getReligion(value);
                    ...
                    plugin.getVisualEffectsService().sendActionBar(player, "§e✨ Религия: '" + religionName + "'. Десятина: 5%, Бонусы активны");
