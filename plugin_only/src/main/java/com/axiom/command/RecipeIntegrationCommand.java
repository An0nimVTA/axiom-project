...
public class RecipeIntegrationCommand implements CommandExecutor {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "/recipeint list" + ChatColor.WHITE + " - List available integrations");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint recipes [category]" + ChatColor.WHITE + " - List integration recipes");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint enable <integration>" + ChatColor.WHITE + " - Enable an integration");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint disable <integration>" + ChatColor.WHITE + " - Disable an integration");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint stats" + ChatColor.WHITE + " - Show integration statistics");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint usage" + ChatColor.WHITE + " - Show recipe usage statistics");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint player [playerName]" + ChatColor.WHITE + " - Show player crafting statistics");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint reload" + ChatColor.WHITE + " - Reload integration recipes");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint check <item1> <item2>" + ChatColor.WHITE + " - Check compatibility between items");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint compat <item>" + ChatColor.WHITE + " - Show compatible items for an item");
        sender.sendMessage(ChatColor.YELLOW + "/recipeint search <keyword>" + ChatColor.WHITE + " - Search for recipes by keyword");
    }
    ...
    private boolean handleEnableCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/recipeint enable <integration|category|recipe_id>");
            return true;
        }
    ...
    private boolean handleDisableCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/recipeint disable <integration>");
            return true;
        }
    ...
    private boolean handleCheckCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 3) {
            sender.sendMessage(ChatColor.RED + "/recipeint check <item1> <item2>");
            return true;
        }
    ...
    private boolean handleSearchCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/recipeint search <keyword>");
            return true;
        }
    ...
    private boolean handleCompatibilityCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "/recipeint compat <item>");
            return true;
        }
    ...
    private boolean handlePlayerStatsCommand(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            if (!(sender instanceof Player)) {
                sender.sendMessage(ChatColor.RED + "Please specify a player name: /recipeint player <username>");
                return true;
            }
