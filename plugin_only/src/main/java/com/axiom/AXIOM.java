...
import com.axiom.command.ModBalanceCommand;
import com.axiom.command.ModBalancerCommand;
import com.axiom.command.ModIntegrationEnhancementCommand;
import com.axiom.command.ModPackManagerCommand;
import com.axiom.command.ModdedEconomicBalanceCommand;
import com.axiom.command.DynamicModBalancerCommand;
import com.axiom.command.RecipeIntegrationCommand;
...
public final class AXIOM extends JavaPlugin {
    ...
    private BorderVisualizationService borderVisualizationService;
    ...
    private DiplomaticImmunityExpansionService diplomaticImmunityExpansionService;
    ...
    private ModdedEconomicBalanceService moddedEconomicBalanceService;
    private DynamicModBalancerService dynamicModBalancerService;
    ...
    public void onEnable() {
        ...
        this.religionMain = new ReligionMenu(this);
        this.citiesMenu = new CitiesMenu(this, nationManager, cityGrowthEngine);
        ...
        this.espionageService = new EspionageService(this, nationManager);
        this.modPackBuilderService = new ModPackBuilderService(this);
        this.modBalancerService = new ModBalancerService(this);
        ...
        this.moddedEconomicBalanceService = new ModdedEconomicBalanceService(this);
        this.dynamicModBalancerService = new DynamicModBalancerService(this);
        ...
        this.borderVisualizationService = new BorderVisualizationService(this);
        ...
        this.diplomaticImmunityService = new DiplomaticImmunityService(this);
        ...
        this.spyService = new SpyService(this, nationManager);
        ...
        this.diplomaticImmunityExpansionService = new DiplomaticImmunityExpansionService(this, nationManager);
        ...
        if (getCommand("create") != null) {
            getCommand("create").setExecutor(new CreateNationCommand(this));
        }
        ...
        if (getCommand("recipeint") != null) {
            getCommand("recipeint").setExecutor(new RecipeIntegrationCommand(this));
        }
        if (getCommand("modenhance") != null) {
            getCommand("modenhance").setExecutor(new ModIntegrationEnhancementCommand(this));
        }
        if (getCommand("moddedecon") != null) {
            getCommand("moddedecon").setExecutor(new ModdedEconomicBalanceCommand(this));
        }
        if (getCommand("modpackm") != null) {
            getCommand("modpackm").setExecutor(new ModPackManagerCommand(this));
        }
        if (getCommand("modbalance") != null) {
            getCommand("modbalance").setExecutor(new ModBalanceCommand(this));
        }
        if (getCommand("modbalancer") != null) {
            getCommand("modbalancer").setExecutor(new ModBalancerCommand(this));
        }
        if (getCommand("dmb") != null) {
            getCommand("dmb").setExecutor(new DynamicModBalancerCommand(this));
        }
    ...
    public ModPackBuilderService getModPackBuilderService() { return modPackBuilderService; }
    public ModdedEconomicBalanceService getModdedEconomicBalanceService() { return moddedEconomicBalanceService; }
    public DynamicModBalancerService getDynamicModBalancerService() { return dynamicModBalancerService; }
    ...
    public EspionageService getEspionageService() { return espionageService; }
    public IntelligenceService getIntelligenceService() { return intelligenceService; }
