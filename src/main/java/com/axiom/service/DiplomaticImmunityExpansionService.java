...
public class DiplomaticImmunityExpansionService {
    ...
    public DiplomaticImmunityExpansionService(AXIOM plugin, NationManager nationManager) {
        this.plugin = plugin;
    ...
    public synchronized String grantImmunity(String grantingNationId, UUID targetPlayerId, String level, int durationHours, Set<String> applicableNations) {
        ...
        immunity.applicableNations = new HashSet<>(applicableNations);
    ...
    public synchronized boolean hasExpandedImmunity(UUID playerId, String nationId) {
        ...
        return immunity.applicableNations.contains(nationId) || immunity.level.equals("full");
    }

    private void processImmunities() {
        for (Map.Entry<UUID, ExpandedImmunity> e : playerImmunities.entrySet()) {
            ExpandedImmunity immunity = e.getValue();
    ...
    public synchronized Map<String, Object> getExpandedImmunityStatistics(String nationId) {
        ...
        for (ExpandedImmunity immunity : playerImmunities.values()) {
            ...
            if ((immunity.applicableNations.contains(nationId) || immunity.level.equals("full")) 
